...
public class CommentController {
    ...
    //The arguments of these methods are imageId, @RequestParam, @PathVariable, imageTitle , text and Http Session
    //The method adds the new comment to the comments table
    //updateComment() method is called  in the business logic to add the comment
    //Redirect to the /images/" + imageId page to show the image list
