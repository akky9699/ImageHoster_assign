...
public class ImageController {
    ...
    // replaced title with id attribute to fetch single record
    // Comment service implelemted to get the comments by image id
    ...
    //editImage function is a validation will allow only  owner of the image to edit the image otherwise it will redirect to the image list.
    //@params:- ImageId,model,session
    ...
    // deleteImageSubmit function is a validation will allow only  owner of the image to delete the image otherwise it will redirect to the image list.
    //@params:- ImageId,model,session
